...
favoriteThings.show = 'The Wonder Years'
...
function greeting( obj ) {
  let { aName: firstName} = obj
  let { bName: lastName} = obj
  let { ctitle: title} = obj
...
function totalPopulation(electoralVotes) {
  let { Utah: firstValue} = electoralVotes
  let { California: secondValue} = electoralVotes
  let { Texas: thirdValue} = electoralVotes
  let { Arizona: fourthValue} = electoralVotes

  return firstValue + secondValue + thirdValue + fourthValue
}
totalPopulation(electoralVotes)
